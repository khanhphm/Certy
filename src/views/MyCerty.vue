          ...
          <h3>
            ...
            <v-tooltip  top>
              <template v-slot:activator="{ on, attrs }">
                  <a v-bind="attrs" v-on="on" :href="'https://ropsten.etherscan.io/token/'+contractAddress+'?a='+account" target="_blank" rel="noopener noreferrer"><v-icon  color="primary" small>mdi-information</v-icon></a>
